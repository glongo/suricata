...
/**
 * Stub for per SIP header detection keyword. Meant to be included into
 * a C file.
 *
 * \file
 *
...
#endif
#ifdef KEYWORD_TOSERVER
    DetectAppLayerInspectEngineRegister2(BUFFER_NAME, ALPROTO_SIP, SIG_FLAG_TOSERVER,
            0, DetectEngineInspectBufferGeneric, GetRequestData);
#endif
#ifdef KEYWORD_TOCLIENT
    DetectAppLayerInspectEngineRegister2(BUFFER_NAME, ALPROTO_SIP, SIG_FLAG_TOCLIENT,
            0, DetectEngineInspectBufferGeneric, GetResponseData);
#endif
