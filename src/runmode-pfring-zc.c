...
int RunModeIdsPfringZCAutoFp(void)
{
    SCEnter();
...
/* We include only if pfring is enabled */
    ...
    SCLogInfo("RunModeIdsPfringZCAutoFp initialised");
#endif /* HAVE_PFRING */

    return 0;
}

int RunModeIdsPfringZCSingle(void)
{
    SCEnter();
...
/* We include only if pfring is enabled */
    ...
    SCLogInfo("RunModeIdsPfringZCSingle initialised");
#endif /* HAVE_PFRING */

    return 0;
}

int RunModeIdsPfringZCWorkers(void)
{
    SCEnter();
...
/* We include only if pfring is enabled */
    ...
    SCLogInfo("RunModeIdsPfringZCWorkers initialised");
#endif /* HAVE_PFRING */
