...
pub unsafe extern "C" fn ScDetectSdpRegister() {
    ...
    let kw = SCSigTableElmt {
        name: b"sdp.media_description.media\0".as_ptr() as *const libc::c_char,
    ...
    G_SDP_MEDIA_DESC_MEDIA_BUFFER_ID = DetectHelperMultiBufferMpmRegister(
        b"sdp.media_description.media\0".as_ptr() as *const libc::c_char,
        b"sdp.media_description.media\0".as_ptr() as *const libc::c_char,
        ALPROTO_SIP,
        true,
        true,
    ...
    let kw = SCSigTableElmt {
        name: b"sdp.media_description.session_info\0".as_ptr() as *const libc::c_char,
    ...
    G_SDP_MEDIA_DESC_SESSION_INFO_BUFFER_ID = DetectHelperMultiBufferMpmRegister(
        b"sdp.media_description.session_info\0".as_ptr() as *const libc::c_char,
        b"sdp.media_description.session_info\0".as_ptr() as *const libc::c_char,
        ALPROTO_SIP,
        true,
        true,
    ...
    let kw = SCSigTableElmt {
        name: b"sdp.media_description.connection_data\0".as_ptr() as *const libc::c_char,
    ...
    G_SDP_MEDIA_DESC_CONNECTION_DATA_BUFFER_ID = DetectHelperMultiBufferMpmRegister(
        b"sdp.media_description.connection_data\0".as_ptr() as *const libc::c_char,
        b"sdp.media_description.connection_data\0".as_ptr() as *const libc::c_char,
        ALPROTO_SIP,
        true,
        true,
    ...
    let kw = SCSigTableElmt {
        name: b"sdp.media_description.encryption_key\0".as_ptr() as *const libc::c_char,
    ...
    G_SDP_MEDIA_DESC_ENCRYPTION_KEY_BUFFER_ID = DetectHelperMultiBufferMpmRegister(
        b"sdp.media_description.encryption_key\0".as_ptr() as *const libc::c_char,
        b"sdp.media_description.encryption_key\0".as_ptr() as *const libc::c_char,
        ALPROTO_SIP,
        true,
        true,
